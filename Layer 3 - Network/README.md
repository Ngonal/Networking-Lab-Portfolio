...
<table>
  ...
  <tr>
    ...
    <td>
      Subnetting Calculation and Design (VLSM), IP Address Allocation, Hierarchical Subnet Allocation, Address Space Conservation, Network Documentation, Connectivity Testing
    </td>
    <td align="center">
      <a href="https://www.netacad.com/resources/lab-downloads" target="_blank" rel="noopener noreferrer">
        <img src="../README%20Elements/Cisco-Packet-Tracer-logo.png" width="40">
