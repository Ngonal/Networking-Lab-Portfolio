...
|:---|:---|:---|:--:|:--:|
| 5 - Application | Servers, Desktops, Load Balancers, Firewalls (NGFW / L7) | HTTP, HTTPS, NFS, DNS, DHCP, SSH, TELNET, FTP, SMTP, NTP, SNMP Syslog / SSL, TLS, AFP, LPP, NCP, NDR, XDR / ADSP, RTCP, PPTP, PAP, RPCP, SDP| 0 | [View](Layer%205%20-%20Application) |
