...
| 3 - Network | Routers, Layer 3 Switches, Firewalls | IPv4, IPv6, ICMP, IGMP, APIPA, SLAAC, BGP, OSPF, EIGRP, IS-IS, RIP, VRF, NAT, HSRP, VRRP, ACLs, Subnetting, FLSM, VLSM | 1 | [View](Layer%203%20-%20Network) |
