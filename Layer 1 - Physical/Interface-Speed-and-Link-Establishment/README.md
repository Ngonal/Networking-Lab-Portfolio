...
| 3 | Links are now up with active LEDs | Tested communication `ping` via Windows Command Prompt - saved configuration with `write` | Communication successful | <img src="Elements/Step3.png"> |
