...
|:---|:---|:---|:---|:---:| 
| 1 | Verified electrical outlet is working using another device (receptable tester/phone charger connected to phone), `SW1` is plugged into electrical outlet, `SW1` power switch is in the **OFF** position | Toggled power switch to **ON** | `Fa0/2` LEDs illuminate; `Fa0/1` remains dark | <img src="Elements/Step1.png"> |
| 2 | Cable conntecting `PC1` to `Fa0/1` is disconnected | Reconnected cable to `Fa0/1` | No change; `Fa0/1` LEDs remain unilluminated | <img src="Elements/Step2.png"> |
